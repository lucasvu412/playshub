...
import { CatBattleShop } from "../typechain-types";

describe("CatBattleShop", function () {
  async function deployCatBattleShopFixture() {
    const [owner, alice] = await hre.ethers.getSigners();
    const Contract = await hre.ethers.getContractFactory("CatBattleShop");
  ...
  describe("Deployment", function () {
    it("Should initialize correctly", async function () {
      const { contract, owner } = await loadFixture(deployCatBattleShopFixture);
